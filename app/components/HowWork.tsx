  ...
  return (<>
    <section className='container bg-gradient-to-b from-[#ffffff] to-[#dddddd] mt-12 overflow-hidden rounded-xl shadow-[rgba(17,_17,_26,_0.1)_0px_4px_16px,rgba(17,_17,_26,_0.1)_0px_8px_24px,rgba(17,_17,_26,_0.1)_0px_16px_56px] p-0'>
        <div className='container grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 md:justify-center lg:justify-between items-center w-full h-full gap-6 p-0'>
            ...
            />
            <div className='w-full lg:px-14 lg:py-10 p-12 flex flex-col justify-center letter item-center lg:items-start lg:justify-start tracking-[-1px]'>
                <h3 className='text-5xl text-secondary font-extrabold mb-6'>{t("title")}</h3>
                <div className='w-[80px] h-[5px] bg-primary mb-8'></div>
                <div className='flex flex-grow flex-nowrap gap-5 mb-5'>
                    <FaWpforms className='text-4xl lg:text-5xl text-primary' />
                    <p className='text-xl text-secondary-dark max-w-[450px]'>{t("step1")}</p>
                </div>
                <div className='flex flex-grow flex-nowrap gap-5 mb-5'>
                    <FaRegCircleCheck className='text-4xl lg:text-5xl text-primary' />
                    <p className='text-xl text-secondary-dark max-w-[450px]'>{t("step2")}</p>
                </div>
                <div className='flex flex-grow flex-nowrap gap-5 mb-6'>
                    <IoCarSportOutline className='text-4xl lg:text-5xl text-primary' />
                    <p className='text-xl text-secondary-dark max-w-[450px]'>{t("step3")}</p>
                </div>
